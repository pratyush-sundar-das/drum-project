...
public class PatchController {
    ...
    public void init() {
        if (patchRepository.count() == 0) {
            ...
            allPads.add(new Pad("pad9", List.of("snare-lofi01.wav", "snare-brute.wav")));
            allPads.add(new Pad("pad10", List.of("snare-808.wav", "snare-electro.wav")));
            allPads.add(new Pad("pad11", List.of("hihat-808.wav", "hihat-electro.wav")));
            ...
            allPads.add(new Pad("pad22", List.of("crash-tape.wav", "crash-acoustic.wav")));
            ...
            // Patch 5: Custom Mix
            allPads.add(new Pad("pad33", List.of("kick-dry.wav", "kick-deep.wav")));
            allPads.add(new Pad("pad34", List.of("snare-dist01.wav", "snare-dist02.wav")));
            allPads.add(new Pad("pad35", List.of("hihat-ring.wav", "hihat-analog.wav")));
            allPads.add(new Pad("pad36", List.of("openhat-slick.wav", "openhat-tight.wav")));
            allPads.add(new Pad("pad37", List.of("perc-tribal.wav", "perc-metal.wav")));
